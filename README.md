...
class Development(Config):
    ...
    DRAGONS = [1396244257, 998194558, 979499093, 781807433]  # List of id's for users which have sudo access to the bot.
    LOAD = []
    NO_LOAD = ['translation']
```
